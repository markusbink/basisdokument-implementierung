    ...
    <>
      {isOnboardingVisible && (
        <div className="z-30 fixed">
          ...
          <div className="w-screen h-screen inset-0 fixed flex items-center justify-center">
            <div className="relative bg-white max-w-5xl w-auto rounded-xl overflow-hidden">
              <button
