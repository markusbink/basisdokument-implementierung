      ...
      {showDevelopersMenu ? (
        <div className="w-full bg-offWhite rounded-md p-6 mt-2">
          ...
          <p className="text-darkGrey text-justify text-md">
            ...
            Das gemeinsam von den Justizministerien Bayerns und Niedersachsens mit den Lehrstühlen für <a href="https://www.uni-regensburg.de/rechtswissenschaft/buergerliches-recht/althammer/aktuelles/index.html" target="_blank" rel="noreferrer">Deutsches Verfahrensrecht (Prof. Dr. Althammer)</a> und für <a href="https://www.uni-regensburg.de/sprache-literatur-kultur/medieninformatik/medieninformatik/index.html" target="_blank" rel="noreferrer">Medieninformatik (Prof. Dr. Wolff)</a> der Universität Regensburg durchgeführte Projekt dient der Gewinnung von Erkenntnissen über die digitalen Möglichkeiten einer formellen Strukturierung des Parteivortrags im Zivilprozess.
            <br/>
            <br/>
            Weitere Informationen zum Projekt finden Sie unter: <a target="_blank" rel="noreferrer" href="https://www.uni-regensburg.de/forschung/reallabor-informationen/informationen-reallabor/informationen-reallabor/index.html">www.parteivortrag.de</a>
          </p>
          <div
          ...
          >
            ...
            {showStudents2021 ? <CaretUp size={12} className="text-darkGrey" weight="bold" /> : <CaretDown size={12} className="text-darkGrey" weight="bold" />}
          </div>
          {showStudents2021 && <div className="grid md:grid-cols-2 grid-cols-1 gap-2 mt-2">
            {studentData2021.map((students, key) => (
              <div className="flex flex-row items-center gap-4 p-4 rounded-md" key={key}>
                <div className="flex flex-col gap-2">
                  <div className="flex flex-row gap-2">
                    <span className="font-bold text-base">{students.group}</span>
                  </div>
                  <div className="flex flex-row gap-2">
          ...
          >
            ...
            {showDevelopers2022 ? <CaretUp size={12} className="text-darkGrey" weight="bold" /> : <CaretDown size={12} className="text-darkGrey" weight="bold" />}
          </div>
          {showDevelopers2022 && <div className="grid md:grid-cols-2 grid-cols-1 gap-2 mt-2">
          ...
          >
            ...
            {showDevelopers2023 ? <CaretUp size={12} className="text-darkGrey" weight="bold" /> : <CaretDown size={12} className="text-darkGrey" weight="bold" />}
          </div>
          {showDevelopers2023 && <div className="grid md:grid-cols-2 grid-cols-1 gap-2 mt-2">
