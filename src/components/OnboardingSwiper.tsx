...
const sliderItems = [
  ...
  {
    videoSrc: "videos/BDMetadataThreading.mp4",
  ...
  {
    videoSrc: "videos/BDBeitragGliederungspunkt.mp4",
  ...
  {
    videoSrc: "videos/BDBezugNehmen.mp4",
  ...
  {
    videoSrc: "videos/BDSichtbarkeit.mp4",
  ...
  {
    videoSrc: "videos/BDSortierung.mp4",
    title: "Sortierung ",
  ...
  {
    videoSrc: "videos/BDMarkierungen.mp4",
    title: "Markierungen",
  ...
  {
    videoSrc: "videos/BDLesezeichen.mp4",
    title: "Lesezeichen",
  ...
  {
    videoSrc: "videos/BDHinweise.mp4",
          ...
          <div>
            <div className="bg-gradient-to-tr from-lightPetrol to-lightPurple lg:p-8 p-4">
              <img
                ...
                src={"BDWelcome.png"}
                alt={"On the Welcome Screen the Basisdokument is shown as it looks on a laptop."}
              />
            </div>
          </div>
          <div className="p-4 max-w-[800px] m-auto">
            <h3 className="leading-loose text-xl text-center text-darkGrey font-semibold mt-8 mb-2">
              {"Willkommen um Basisdokument!"}
            </h3>
            <p className="text-center text-mediumGrey">{"Das Basisdokument unterstützt die Digitalisierung ziviler Gerichtsverfahren. In dieser kurzen Einführung werden Ihnen die Funktionen des Basisdokuments erläutert."}</p>
          </div>
        </SwiperSlide>
