export const Discussion = () => {
  return (
    <div className="bg-lightGrey h-full overflow-y-scroll p-4 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-lightPurple text-black p-4 border border-darkPurple rounded-lg">
              ...
              <p>
                ...
                Consequuntur dolorum earum dolores omnis odit, voluptas ratione?
                Praesentium reprehenderit perspiciatis repudiandae officia
                veniam qui facere at deserunt, harum ab pariatur beatae?
              </p>
            </div>
