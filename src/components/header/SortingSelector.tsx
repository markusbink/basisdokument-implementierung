...
export const SortingSelector: React.FC<IProps> = ({selectedSorting, setSelectedSorting}) => {
  ...
  return (
    ...
    >
      <DropdownMenu.Trigger className="flex flex-row justify-between bg-lightGrey items-center rounded-md gap-2 pl-2 pr-2 pt-1 pb-1 hover:cursor-pointer w-[100px] font-bold">
        <p>{selectedSorting}</p>
